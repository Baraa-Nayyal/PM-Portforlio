  ...
  return (
    <>
      ...
      {/* <img
        ...
        /> */}
      <div
        className="flex flex-col xl:flex-row gap-x-60 justify-center w-full items-center container mx-auto px-32"
      ...
      >
        ...
        >
          ...
          <span
            ...
            data-aos-duration="1000"
            data-aos-delay="150"
            className="font-extrabold xl:text-[50px] sm:text-[40px] text-[30px] text-[#961A7A] tracking-[24px]  sm:tracking-[30px] xl:tracking-[38px] ml-4 xl:ml-0"
          >
            RIHAWEI
          </span>
          <p
